...
export class ProductListComponent implements OnInit, OnDestroy {
    ...
    private _giftsModel: PagedList<GiftDto> = { page: 0, count: 0 };
    public get giftsModel(): PagedList<GiftDto> {
        return this._giftsModel;
    }
    ...
    constructor(
        ...
        this._subsink.add(this._toolbarService.create.subscribe(() => { this._router.navigateByUrl('/gift/create') }));
    }
    ...
    public async ngOnInit(): Promise<void> {
        ...
        this._toolbarService.isVisibleToCreate(true) //create iptal edildi.
        console.log(this._giftsModel);
    ...
    public async onDeleteGift(product: GiftDto): Promise<void> {
    ...
    public async onStatusChanged(e: any): Promise<void> {
        ...
        this._productFilter.filter?.filters?.push({ field: "isDeleted", operator: "eq", value: status })
        await this.getProducts();
