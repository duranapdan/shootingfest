...
export class ProductListComponent implements OnInit, OnDestroy {
    ...
    private _productsModel: PagedList<ProductForListDto> = { page: 0, count: 0 };
    public get productsModel(): PagedList<ProductForListDto> {
    ...
    constructor(
        ...
        this._subsink.add(this._toolbarService.create.subscribe(() => { this._router.navigateByUrl('/faq/create') }));
    }
    ...
    public async onDeleteProduct(product: ProductForListDto): Promise<void> {
